...
class Pembimbingandewasa extends CI_Controller {
	private $data;
	...
	public function __construct(){
		...
		$this->data['title'] = 'Pembimbingan Dewasa';
	...
	public function lists(){
		...
		$filters[] = "JENIS_PEMBIMBINGAN_ID = '1'";
		//var_dump($_POST['nama']);
		...
		$jenis = array();
		$filter = array();
		$filter[] = " NAMA_JENIS = 'Dewasa' ";		
		$data = $this->jenispembimbingan_model->get($filter);
		if (empty($data)) {
